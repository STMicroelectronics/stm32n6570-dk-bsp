...
This **stm32n6570-dk** MCU component repository is one element of the **STM32CubeN6** MCU embedded software package, providing the **STM32N6570-DK** BSP BOARD component part.

## Release note

Details about the content of this release are available in the release note [here](https://htmlpreview.github.io/?https://github.com/STMicroelectronics/stm32n6570-dk-bsp/blob/main/Release_Notes.html).
...
* [stm32-imx335](https://github.com/STMicroelectronics/stm32-imx335)
